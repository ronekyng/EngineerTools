...
/* at Fri Sep 01 15:48:55 2017
 */
/* Compiler settings for ATLAddMenus.idl:
...
#ifndef __ATLAddMenus_i_h__
#define __ATLAddMenus_i_h__
...
#ifndef __IAddMenus_FWD_DEFINED__
#define __IAddMenus_FWD_DEFINED__
typedef interface IAddMenus IAddMenus;
#endif 	/* __IAddMenus_FWD_DEFINED__ */
...
#ifndef __AddMenus_FWD_DEFINED__
#define __AddMenus_FWD_DEFINED__

#ifdef __cplusplus
typedef class AddMenus AddMenus;
#else
typedef struct AddMenus AddMenus;
#endif /* __cplusplus */

#endif 	/* __AddMenus_FWD_DEFINED__ */
...
#ifndef __IAddMenus_INTERFACE_DEFINED__
#define __IAddMenus_INTERFACE_DEFINED__

/* interface IAddMenus */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IAddMenus;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("D60A14C4-14CA-4E0C-8447-A099CA584858")
    IAddMenus : public IDispatch
    {
    public:
    };
    ...
    interface IAddMenus
    {
        CONST_VTBL struct IAddMenusVtbl *lpVtbl;
    };
...
#define IAddMenus_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IAddMenus_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IAddMenus_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IAddMenus_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IAddMenus_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IAddMenus_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IAddMenus_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* __IAddMenus_INTERFACE_DEFINED__ */



#ifndef __ATLAddMenusLib_LIBRARY_DEFINED__
#define __ATLAddMenusLib_LIBRARY_DEFINED__

/* library ATLAddMenusLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_ATLAddMenusLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("C51ECAC6-6B62-455C-8801-1C3F117B5FDC")
CompReg;
#endif

EXTERN_C const CLSID CLSID_AddMenus;

#ifdef __cplusplus

class DECLSPEC_UUID("F92FB702-F2F1-4CC3-897D-F9C4EA4F57AA")
AddMenus;
#endif
#endif /* __ATLAddMenusLib_LIBRARY_DEFINED__ */
